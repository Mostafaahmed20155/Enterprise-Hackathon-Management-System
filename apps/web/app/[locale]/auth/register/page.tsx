          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <UserCircle className="absolute start-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400" />
                <Input
                  id="name"
                  name="name"
                  type="text"
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="terms" className="ms-2 block text-sm text-gray-700 dark:text-gray-300 cursor-pointer">
                {t('auth.agreeToTerms')}{' '}
