...
export default function JudgingPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto">
      {/* Header */}
      <div className="mb-8 relative overflow-hidden rounded-2xl bg-gradient-to-br from-primary via-green-600 to-emerald-900 p-8 text-white shadow-xl">
        ...
        <div className="relative z-10">
          ...
          <p className="text-green-50/95 text-lg">{t('subtitle')}</p>
        </div>
      </div>
