...
function getRoleBadgeColor(roleName: string) {
  switch (roleName) {
    ...
    case 'ORGANIZER':   return 'bg-purple-100 text-purple-700 border-purple-200 dark:bg-purple-900/30 dark:text-purple-400 dark:border-purple-800';
      ...
      <Card className="border-0 shadow-sm overflow-hidden">
        ...
        <CardContent className="px-6 pb-6 -mt-12">
          <div className="flex items-end gap-4">
            <div className="w-20 h-20 bg-gradient-to-br from-primary to-purple-600 rounded-2xl flex items-center justify-center text-white font-bold text-2xl shadow-lg ring-4 ring-white dark:ring-gray-900">
